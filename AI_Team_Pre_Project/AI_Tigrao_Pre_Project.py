...
from CoreApp.Cliente_cli import ChatCLI
import sys
import json
# SoftwareAI
##############################################################################################
class Pre_Project_Document:
    ...
    def AI_1_Pre_Project_Document_Writer(mensagem):
        """
        Nome da IA: Tigrao \n
        ...
        path_name_doc_Pre_Projeto = f"Work_Environment/Create_doc_Pre_Projeto/documento_pre_projeto.txt"

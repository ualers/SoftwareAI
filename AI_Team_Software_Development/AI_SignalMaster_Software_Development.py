...
import subprocess
import threading
from CoreApp.SoftwareAI_Core import AutenticateAgent, ResponseAgent, python_functions, Agent_files, Github_functions,Agent_files_update
import sys
...
class SoftwareDevelopment_SignalMaster:
    ...
    ##############################################################################################
    def AI_SignalMaster(python_file_path, repo_name: str, branch_name: str, analisyspng=None):
        ...
        vectorstore_in_assistant = [vector_store_id_all_software_in_company]

...
client = OpenAI(
    api_key=chaves_ia.chaves_ia_openai(),
)
...
class ResponseAgent:
    def ResponseAgent_message_completions(prompt, sistema = "", json_format = True):
        ...
        key_api = chaves_ia.chaves_ia_openai()
            ...
            if run_status.status == 'requires_action':
                for tool_call in run_status.required_action.submit_tool_outputs.tool_calls:
                    if tool_call.type == 'function':
                        ...
                        # elif function_name == 'upload_files_to_github':
                        #     args = json.loads(function_arguments)
                        #     result = upload_files_to_github(
...
class Github_functions:
    ...
    def QuantumCore_github_keys():
        ...
        github_token = "AI api token on github"

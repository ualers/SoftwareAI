...
class Softwareanaysis:
    ...
    def AI_SynthOperator(self, path_Roadmap, cronograma_do_projeto, planilha, doc_Pre_Projeto):
        ...
        AI_SynthOperator_Software_requirements_analyst = AutenticateAgent.create_or_auth_AI(key, instructionAI_SynthOperator, nameassistant, model_select, tools, vectorstore_in_assistant)
        ...
        mensaxgem = f"""
        Analise os quatro arquivos relacionados a um projeto de software\n
